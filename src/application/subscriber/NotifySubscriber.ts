...
import ClaimRejectedEvent, { NAME as ClaimRejectedName } from '@app/domain/claim/event/ClaimRejectedEvent'
import DoctorAnswerEvent, { NAME as DoctorAnswerName } from '@app/domain/claim/event/DoctorAnswerEvent'
...
import NewFeedbackEvent, { NAME as NewFeedbackName } from '@app/domain/feedback/event/NewFeedbackEvent'
